...
<div class="container my-5">
  <div class="row">
    <div class="col text-center">
      ...
      <p>Welcome, <?php echo htmlspecialchars($username); ?>! This is the dashboard for the finance department.</p>
    </div>
  </div>
          ...
          <form id="taskForm" method="post">
            ...
            <div class="mb-4">
              ...
              <select name="assigned_to" id="assigned_to" class="form-select" required>
                <?php
                $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
                $sql = "SELECT id, firstName FROM users WHERE department = 'finance'";
                $st = $conn->prepare($sql);
                $st->execute();
                $users = $st->fetchAll();
