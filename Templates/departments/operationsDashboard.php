...
<div class="container my-5">
  <div class="row">
    <div class="col text-center">
      <h2 class="mb-3">Operations Dashboard</h2>
      <p>Welcome, <?php echo htmlspecialchars($username); ?>! This is the dashboard for the Operations department.</p>
    </div>
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="taskForm" method="post">
            ...
            <input type="hidden" name="department" id="department" value="operations">
            ...
            <div class="mb-4">
              ...
              <select name="assigned_to" id="assigned_to" class="form-select" required>
                <?php
                $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
                $sql = "SELECT id, firstName FROM users WHERE department = 'operations'";
                $st = $conn->prepare($sql);
                $st->execute();
                $users = $st->fetchAll();
